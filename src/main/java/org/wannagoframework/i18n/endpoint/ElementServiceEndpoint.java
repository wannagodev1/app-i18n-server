...
import org.wannagoframework.i18n.service.ElementService;
...
public class ElementServiceEndpoint extends BaseEndpoint {
  ...
  public ResponseEntity<ServiceResult> save(
      @RequestBody SaveQuery<org.wannagoframework.dto.domain.i18n.Element> query) {
    String loggerPrefix = getLoggerPrefix("save");
    try {
      return handleResult(loggerPrefix, mapperFacade.map(elementService
              .save(mapperFacade
                  .map(query.getEntity(), Element.class, getOrikaContext(query))),
          org.wannagoframework.dto.domain.i18n.Element.class, getOrikaContext(query)));
    } catch (Throwable t) {
      return handleResult(loggerPrefix, t);
    }
  }
